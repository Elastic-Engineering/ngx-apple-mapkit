...
export declare interface MapKitGetSelectedAnnotations
	extends MapKit.Annotation {
	_impl: any;
}
export declare interface MapKitLoaded {
	...
	showItems: (
		items: MapKitItem | MapKitItem[],
		mapShowItemOptions?: MapShowItemOptionsInterface
	) => void;
...
export declare type MapTypeString =
	| "standard"
	| "mutedStandard"
	| "hybrid"
	| "satellite";
