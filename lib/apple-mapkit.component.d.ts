...
export declare class AppleMapkitComponent
	implements DoCheck, OnInit, AfterViewInit
{
	...
	constructor(
		...
		viewTemplateRef: ViewContainerRef,
	...
	static ɵcmp: i0.ɵɵComponentDeclaration<
		...
		never,
		{
			...
			settings: { alias: "settings"; required: true };
			logging: { alias: "logging"; required: false };
			language: { alias: "language"; required: false };
		},
		{ onLoaded: "onLoaded" },
		["annotations"],
		["*"],
